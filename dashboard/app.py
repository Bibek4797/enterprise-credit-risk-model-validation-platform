...
st.set_page_config(
    page_title="Executive Dashboard | Credit Risk Platform",
    page_icon="🏦",
    layout="wide",
    initial_sidebar_state="expanded",
)

st.title("🏦 Enterprise Credit Risk & Model Governance Platform")
st.caption("Tier-1 Banking Model Risk Management (SR 11-7 / Basel III / FCRA / ECOA)")
st.markdown("---")

st.markdown("## 📊 Executive Risk Committee Dashboard")
